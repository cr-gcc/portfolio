...
export function TechStack() {
    return (
        <section id="stack" className="scroll-mt-20 md:scroll-mt-16 border-t border-zinc-200/10 py-12 sm:py-16 lg:py-20">
            ...
            <div className="overflow-hidden rounded-2xl border border-blue-500/15 bg-zinc-950/35 backdrop-blur-md">
                {technologyGroups.map((group, index) => (
                    <div
                        key={group.title}
                        className={`p-4 sm:p-6 lg:p-8 ${index !== 0 ? "border-t border-zinc-800/80" : ""}`}
                    >
