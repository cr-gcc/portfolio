...
export function Header() {
    ...
    return (
        <>
            ...
            <div id="mobile-menu" className={`overflow-hidden border-t border-zinc-200/10 bg-[#060b18]/95 backdrop-blur-xl transition-all duration-300 md:hidden ${isMenuOpen ? "max-h-80 opacity-100" : "max-h-0 opacity-0"}`}>
                <nav
